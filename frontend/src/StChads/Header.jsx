...
export default function Header() {
  ...
  return (
    <>
      <head>
          <title>St Chad's Whitleigh</title>
          <meta
            name="description"
        ...
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-3">
          ...
          <div className={`${isOpen ? "" : "hidden"} w-full md:flex md:w-auto`} id="mobile-menu">
            <ul className="font-medium flex flex-col md:flex-row md:space-x-8 mt-4 md:mt-0">
              ...
              <li><a href="our-team" className="block px-4 py-2 text-nav hover:text-primary">Our Team</a></li>
              <li><a href="pricing" className="block px-4 py-2 text-nav hover:text-primary">Pricing</a></li>
              <li><a href="http://localhost:5173/" className="block text-nav px-4 py-2 hover:text-primary">Demo</a></li>
              <li>
                <a
                  href="contact-us"
