...
import LogoBrown from "../../public/assets/shared/Logo-brown.png";
import LogoBrownAlt from "../../public/assets/shared/Logo-brown-alt.png";
...
export default function Header() {
  ...
  return (
    <>
      <head>
        <title>CourtFrog</title>
        <meta
          name="description"
          content="Frog it, Frog all over the court."
        />
        <meta charSet="utf-8" />
      ...
      <nav className="nav">
        <link rel="icon" type="image/x-icon" href="/public/assets/Logo-brown-flav.ico"></link>
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-3">
          ...
          <a href="/" className="flex items-center space-x-3 rtl:space-x-reverse group">
            ...
            <span className="self-center text-2xl font-semibold">{churchName}</span>
          </a>
          ...
          <div className={`${isOpen ? "" : "hidden"} w-full md:flex md:w-auto`} id="mobile-menu">
            <ul className="font-medium flex flex-col md:flex-row md:space-x-8 mt-4 md:mt-0">
              ...
              <li><a href="http://demo.localhost:5173/" className="block px-4 nav py-2 hover:text-primary">Demo</a></li>
              <li>
                <a
                  href="contact-us"
                  className="block px-4 py-2 bg-action nav rounded-lg shadow-lg text-white hover:bg-action/80"
                >
                  Contact Us
                </a>
              </li>
